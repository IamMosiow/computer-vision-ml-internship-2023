...
int main()
{
    ...
    ifstream ifs(string("../../Srcs//object_detection_classes_coco.txt").c_str());
    string line;
    ...
    auto model = readNet("../../Srcs/frozen_inference_graph.pb",
        "../../Srcs//ssd_mobilenet_v2_coco_2018_03_29.pbtxt.txt", "TensorFlow");
    // read the image from disk
    Mat image = imread("../../Srcs/backiee-258236.jpg");
    if (image.empty())
    {
        cout << "error reading the image" << endl;
    }
    Size nSize(1920, 1080);
    resize(image, image, nSize);
